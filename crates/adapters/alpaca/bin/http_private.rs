...
use nautilus_alpaca::{
    common::enums::{ALPACAInstrumentType, ALPACAPositionMode},
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Set position mode
    let resp = client.set_position_mode(ALPACAPositionMode::NetMode).await;
    match resp {
    ...
    let instrument_type = ALPACAInstrumentType::Swap;
