...
//! Enumerations representing ALPACA WebSocket message metadata and codes.
...
#[serde(rename_all = "camelCase")]
pub enum ALPACASubscriptionEvent {
    Subscribe,
    Unsubscribe,
}
