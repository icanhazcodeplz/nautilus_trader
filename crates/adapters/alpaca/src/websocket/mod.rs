...
//! WebSocket client implementation for the ALPACA v5 API.
//!
//! This module provides real-time streaming connectivity to ALPACA WebSocket endpoints,
//! supporting:
//!
...
// Re-exports
pub use crate::websocket::client::ALPACAWebSocketClient;
