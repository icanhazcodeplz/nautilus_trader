...
pub struct ALPACADataClientConfig {
    ...
    pub instrument_types: Vec<ALPACAInstrumentType>,
    /// Contract type filter applied to loaded instruments.
    pub contract_types: Option<Vec<ALPACAContractType>>,
    ...
    /// When true the client will use ALPACA demo endpoints.
    pub is_demo: bool,
...
impl Default for ALPACADataClientConfig {
    fn default() -> Self {
        Self {
            ...
            api_secret: None,
            api_passphrase: None,
            instrument_types: vec![ALPACAInstrumentType::Spot],
            contract_types: None,
            base_url_http: None,
