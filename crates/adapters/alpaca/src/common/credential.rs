...
//! ALPACA API credential storage and request signing helpers.
...
/// ALPACA API credentials for signing requests.
///
/// Uses HMAC SHA256 for request signing as per ALPACA API specifications.
...
impl Credential {
    ...
    /// Signs a request message according to the ALPACA authentication scheme.
    ///
...
mod tests {
    ...
    fn test_post_algo_order() {
        ...
        // Test with an algo order JSON body (array format as ALPACA expects)
