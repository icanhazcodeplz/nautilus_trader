...
//! Python bindings exposing ALPACA HTTP helper functions and data conversions.
...
use crate::{
    common::enums::{ALPACAInstrumentType, ALPACAPositionMode, ALPACATradeMode},
...
impl ALPACAHttpClient {
    ...
    fn py_set_position_mode<'py>(
        &self,
        py: Python<'py>,
        position_mode: ALPACAPositionMode,
