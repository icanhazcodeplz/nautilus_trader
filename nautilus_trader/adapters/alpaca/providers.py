...
class AlpacaInstrumentProvider(InstrumentProvider):
    """
    Provides Nautilus instrument definitions from Alpaca.
    ...
    def instruments_pyo3(self) -> list[Any]:
        """
        Return all Alpaca PyO3 instrument definitions held by the provider.
    ...
    async def load_ids_async(
        ...
        for instrument_id in instrument_ids:
            PyCondition.equal(instrument_id.venue, ALPACA_VENUE, "instrument_id.venue", "ALPACA")
