CATALOG_OPTIONS = dict(
    ...
    chnrsm=dict(symbol="CHNR", start="2025-10-13T00:00:00Z", end="2025-10-13T11:25:00Z", notes="$7"),
    sgbx=dict(symbol="SGBX", start="2025-11-13T00:00:00Z", end="2025-11-14T00:00:00Z", notes="$4"),
    sgbxsm=dict(symbol="SGBX", start="2025-11-13T00:00:00Z", end="2025-11-13T12:00:00Z", notes="$4"),
    cnck=dict(symbol="CNCK", start="2025-12-01T00:00:00Z", end="2025-12-01T23:00:00Z", notes=""),
    radxsm=dict(symbol="RADX", start="2025-12-15T12:16:00Z", end="2025-12-15T12:17:10Z", notes="$8 to $26"),
    radx=dict(symbol="RADX", start="2025-12-15T00:00:00Z", end="2025-12-15T23:00:00Z", notes="$8 to $26"),
    bttc=dict(symbol="BTTC", start="2025-12-11T00:00:00Z", end="2025-12-11T23:00:00Z", notes="4 o 12"),
    crbp=dict(symbol="CRBP", start="2025-12-11T00:00:00Z", end="2025-12-11T23:00:00Z", notes="$10. Massive early drop"),
    migi=dict(symbol="MIGI", start="2025-12-11T00:00:00Z", end="2025-12-11T23:00:00Z", notes="7 to 16"),
    jzxn=dict(symbol="JZXN", start="2025-12-12T00:00:00Z", end="2025-12-12T23:00:00Z", notes="5 to 12 to 2.5"),
    mbrx=dict(symbol="MBRX", start="2025-12-17T00:00:00Z", end="2025-12-17T23:00:00Z", notes="4.5 to 6.5 to 4"),
    lhai=dict(symbol="LHAI", start="2025-12-18T00:00:00Z", end="2025-12-18T23:00:00Z", notes="10 to 15"),
    azi=dict(symbol="AZI", start="2025-12-19T00:00:00Z", end="2025-12-19T23:00:00Z", notes="1.5 to 3.5"),
